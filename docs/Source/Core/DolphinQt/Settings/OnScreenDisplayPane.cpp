...
void OnScreenDisplayPane::CreateLayout()
{
  ...
  m_show_shader_flags =
      new ConfigBool(tr("Show Shader Flags"), Config::GFX_OVERLAY_SHADER_FLAGS);
  m_show_shader_hunting =
      new ConfigBool(tr("Shader Hunting"), Config::GFX_OVERLAY_SHADER_HUNTING);

  debug_layout->addWidget(m_show_statistics, 0, 0);
  debug_layout->addWidget(m_show_proj_statistics, 0, 1);
  debug_layout->addWidget(m_show_shader_flags, 1, 0);
  debug_layout->addWidget(m_show_shader_hunting, 1, 1);
...
void OnScreenDisplayPane::AddDescriptions()
{
  ...
  static const char TR_SHOW_PROJ_STATS_DESCRIPTION[] =
      QT_TR_NOOP("Shows various projection statistics.<br><br><dolphin_emphasis>If unsure, "
                 "leave this unchecked.</dolphin_emphasis>");
  static const char TR_SHOW_SHADER_FLAGS_DESCRIPTION[] =
      QT_TR_NOOP("Shows ShaderHunter condition flag names and their current active/inactive "
                 "status in the top-left corner."
                 "<br><br><dolphin_emphasis>If unsure, leave this unchecked.</dolphin_emphasis>");
  static const char TR_SHOW_SHADER_HUNTING_DESCRIPTION[] =
      QT_TR_NOOP("Shows Shader Hunting status in the top-left corner, including the selected "
                 "shader hash, draw-call filter state, and selected texture hashes."
                 "<br><br><dolphin_emphasis>If unsure, leave this unchecked.</dolphin_emphasis>");
  ...
  m_show_shader_flags->SetDescription(tr(TR_SHOW_SHADER_FLAGS_DESCRIPTION));
  m_show_shader_hunting->SetDescription(tr(TR_SHOW_SHADER_HUNTING_DESCRIPTION));
}
