...
{
  constants = {};
  constants.vr_layer_override = {-1, 0, 0, 0};
...
{
  if (constants.vr_layer_override[0] != m_vr_texture_layer_override)
  {
    constants.vr_layer_override[0] = m_vr_texture_layer_override;
    constants.vr_layer_override[1] = 0;
    constants.vr_layer_override[2] = 0;
    constants.vr_layer_override[3] = 0;
    dirty = true;
  }
