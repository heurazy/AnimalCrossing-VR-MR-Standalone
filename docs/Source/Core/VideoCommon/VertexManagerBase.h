...
private:
  ...
  bool m_has_recent_fullscreen_mono_draw = false;
  u32 m_recent_fullscreen_mono_draw = 0;
  u64 m_recent_fullscreen_mono_gs_hash = 0;
  u64 m_recent_fullscreen_mono_tex0 = 0;
  u64 m_recent_fullscreen_mono_tex1 = 0;
